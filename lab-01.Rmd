...
NA stands for Data not available, and since there are unknown data in the column, a calculation of mean would return NA as not all values are known 
...
**Write your answer here**
mean affected by outliers median does not
